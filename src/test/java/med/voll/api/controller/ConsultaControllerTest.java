...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosAgendarConsulta> agendarConsultaJasonTester;
    ...
    void agendarEscenario2() throws Exception {
        ...
        var response = mockMvc.perform(post("/consultas")
                ...
                .content(agendarConsultaJasonTester.write(new DatosAgendarConsulta(2l,14l, fecha,especialidad)).getJson())
